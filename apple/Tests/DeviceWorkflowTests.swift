...
// swiftc -swift-version 6 SemanticIf/Sources/SemanticIf/{SemanticIfPrompt,SemanticIfScoring}.swift ShortReel/Services/DevicePrompts/{WarmUpScript,PhonePlaybackTracker,PhoneSubmissionGuard,PhoneSubmissionCheckpoint,DeviceRunJournal,DevicePromptPlan,DevicePromptPlanner,DeviceWorkflow,PhoneVisionTypes,PhoneVisualRunner,WarmUpStateTree,DevicePromptSession,HomeScreenRemovalGuard,WarmUpAccountClassifier,WarmUpFailureClassifier}.swift Tests/DeviceWorkflowTests.swift -o /tmp/shortreel-workflow-tests
@main @MainActor
